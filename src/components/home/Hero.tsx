  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="container-x relative z-10 flex flex-col items-center pt-24 pb-28 text-center sm:pt-28"
      >
        <motion.div
        ...
        <h1 className="max-w-[16ch] font-serif text-[2.65rem] leading-[1.04] font-medium text-cream-50 sm:text-6xl lg:text-[4.75rem] xl:text-[5.25rem]">
          {title.map((word, i) => (
            <motion.span
              key={word}
        ...
        <motion.div
          ...
          className="mt-14 flex flex-wrap items-center justify-center gap-x-8 gap-y-3 text-[0.72rem] tracking-[0.16em] text-cream-100/55 uppercase"
        >
