...
export default async function AccountPage() {
  ...
  const stats = [
    { label: 'Sipariş', value: orderCount, href: '/account/orders', Icon: Package },
    { label: 'Favori', value: favoriteCount, href: '/account/favorites', Icon: Heart },
    { label: 'Adres', value: addressCount, href: '/account/addresses', Icon: MapPin },
  ];
