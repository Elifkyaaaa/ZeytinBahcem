...
const folders = [
  { value: 'elmora/products', label: 'Ürün görselleri' },
  { value: 'elmora/kategoriler', label: 'Kategori görselleri' },
  { value: 'elmora/blog', label: 'Blog kapakları' },
  { value: 'elmora/slider', label: 'Slider görselleri' },
];
